...
* included in `tidyverse`: `dplyr`, `tibble`, `ggplot2`, `readr`, `stringr`, `purrr`,`lubridate`

* others: `DBI`, `directlabels`, `editData`,  , `openair`, `raster`, `RColorBrewer`, `readxl`, `RSQLite`, `RODBC`, `shiny`, `WriteXLS`, `zoo`, `Rcpp`
