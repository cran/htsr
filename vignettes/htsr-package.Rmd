...
* `f_convert_hts2hdsm (files, freqs, units, unit_factors, fileo = "calibration_data")` Convert hts files in calibration input format to be used in HDSM.

* `f_convert_hdsm2hts (filein, station = "sta", var)` converts a HDSM output file in hts files for plotting
